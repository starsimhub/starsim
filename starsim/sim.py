...
class Sim:
    ...
    def step(self):
        ...
        self.dists.jump()  # was to=self.ti+1, but jumping to fixed ti causes issues with autojump if a distribution is called multiple times per step
