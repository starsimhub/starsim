...
__all__ = ['Route', 'Network', 'DynamicNetwork', 'SexualNetwork', 'MetapopulationRoute', 'GravityNetwork']
...
class GravityNetwork(MetapopulationRoute):
    """
    ...
    def compute_transmission(self, rel_sus, rel_trans, disease_beta, disease=None):
        ...
        from .diseases import MetapopCompatible
