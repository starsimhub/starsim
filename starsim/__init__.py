    ...
    if options.install_fonts:
        ...
        if not test_file.exists():
            ...
            try:
                ...
                if options.verbose:
                    print('\nNote: rebuilding the font cache only happens once on first import, or set the environment variable STARSIM_FONTS=0 to disable.')
