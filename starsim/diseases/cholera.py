...
class Cholera(ss.Infection):
    ...
    def init_results(self, sim):
        ...
        self.results += ss.Result(self.name, 'cum_infections', sim.npts, dtype=int)
        ...
        self.results += ss.Result(self.name, 'env_prev', sim.npts, dtype=float)
        self.results += ss.Result(self.name, 'env_conc', sim.npts, dtype=float)
    ...
    def update_results(self, sim):
        ...
        self.results['cum_infections'][sim.ti] = np.sum(self.results['new_infections'][:sim.ti+1])
