...
def sample(dist=None, par1=None, par2=None, size=None, **kwargs):
    ...
    **Examples**::
        ...
        ss.sample(dist='lognormal_int', par1=5, par2=3) # returns a lognormally distributed set of values with mean 5 and std 3
...
def binomial_filter(prob, arr):
    ...
    **Example**::
        ...
        inds = ss.binomial_filter(0.5, np.arange(20)**2) # Return which values out of the (arbitrary) array passed the coin flip
    '''
