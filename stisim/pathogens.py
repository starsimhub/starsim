...
class Gonorrhea(Pathogen):
    ...
    def update_states(self, sim):
        # What if something in here should depend on another pathogen?
        # I guess we could just check for it e.g., 'if HIV in sim.pathogens' or
    ...
    def initialize(self, sim):
        # Do any steps in this method depend on what other pathogens are going to be added? We can inspect
        # them via sim.pathogens at this point
        Pathogen.initialize(self, sim)
