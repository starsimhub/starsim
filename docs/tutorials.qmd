...
::: {.grid}
::: {.g-col-4}
[**T1 - Introduction to Starsim**](tutorials/t1_intro.qmd)

A quick introduction to the Starsim framework.
:::

::: {.g-col-4}
[**T2 - Building a simulation**](tutorials/t2_model.qmd)

How to build your first simulation.
:::

::: {.g-col-4}
[**T3 - Demographics**](tutorials/t3_demographics.qmd)

Implementing demographics: births, deaths, and population structure.
:::

::: {.g-col-4}
[**T4 - Diseases**](tutorials/t4_diseases.qmd)

How to implement disease dynamics.
:::

::: {.g-col-4}
[**T5 - Networks**](tutorials/t5_networks.qmd)

How diseases spread between agents: networks and mixing pools.
:::

::: {.g-col-4}
[**T6 - Interventions**](tutorials/t6_interventions.qmd)
...
4. Convert to Jupyter: `./convert_notebooks.sh` (or just open them directly if `jupytext` is installed)
