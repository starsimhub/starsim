...
For a comparison of optimization-based and Bayesian approaches to calibration, see the [SIR calibration workflows notebook](workflows_sir_calibration.ipynb).
