...
## Release procedure
1. Merge all PRs into the release candidate branch (e.g. `rc3.1.1`)
2. Update the version from e.g. `3.1.1.dev0` to `3.1.1`, and update the date
3. Mark the PR ready
4. If tests pass, merge
5. On GitHub, go to *Relases > Draft a new release*
6. Create a new release candidate branch (e.g. `rc3.1.2`), and make a draft PR
