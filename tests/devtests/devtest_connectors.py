...
plt.figure()
plt.plot(sim_hiv.yearvec, sim_hiv.results.syphilis.n_infected, label='With HIV')
plt.plot(sim_nohiv.yearvec, sim_nohiv.results.syphilis.n_infected, label='Without HIV')
